...
export const SEASON_BY_MONTH: Record<MonthNumber, MonthSeason> = {
  ...
  11: {
    fruits: ["사과(부사)", "배", "감", "단감", "유자", "모과", "키위", "감귤"],
    veggies: ["배추", "무", "고구마", "우엉", "연근", "브로콜리", "대파"],
  },
  12: {
    fruits: ["감귤", "한라봉", "사과(부사)", "배", "단감", "유자", "딸기"],
