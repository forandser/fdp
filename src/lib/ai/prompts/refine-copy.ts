...
절대 규칙:
- fruit-copy.ts의 규칙 1~67 모두 유지 (특히 규칙 4·5·6 과장·의학·환각 금지, 규칙 55 품종·수치 정합, 규칙 56 산지 정합, 규칙 65 heroKicker 정합, 규칙 67 비주얼 DNA 각도 유지)
...
비주얼 DNA 각도 유지 (규칙 67):
- 초안이 그 품목의 "팔리는 비주얼 포인트"(예: 사과 껍질 광택·아삭 단면, 곶감 쫀득한 결·하얀 분, 참외 노란 채도)를 keyPoints·story·highlightBox에서 살렸는지 점검하세요.
  각도가 흐릿하면 그 포인트를 살려 다듬되, 감각어는 그 품목 sensoryWords 풀에서만(규칙 42) 쓰고 이 포인트로 수치·산지·인증을 창작하지 마세요(규칙 6·55·56).
