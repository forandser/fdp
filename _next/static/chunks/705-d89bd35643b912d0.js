...
53. [v10-b \xb7 후킹 최우선 지시] 상품명(productType)과 기본 정보(품종\xb7산지\xb7중량\xb7당도\xb7수확일\xb7인증)를 조합해
    "그 상품을 처음 보는 사람이 3초 안에 스크롤을 멈추게 만드는" 강력한 후킹을 headline\xb7subheadline\xb7highlightBox 세 곳에
    반드시 배치하세요. 형식은 규칙 41의 4유형 중 택1이지만, 강도는 아래 예시 수준.

    좋은 후킹 예시 (레퍼런스 페이지 톤):
    - 아보카도: "오늘도 신선한 아보카도 \xb7 From. 멕시코 / 프리미엄 아보카도"
    - 홍로사과: "아삭아삭 달고 맛있는 홍로사과 / 정성 가득"
    - 알타킹 딸기: "알타킹 딸기 소싱 스토리 / 단단하지만 과즙도 풍부한 인기 딸기"
    - 새벽녘 복숭아: "새벽녘 농수산 \xb7 고당도 복숭아만의 '특별함'"
    - 석류 (건강기능): "석류추출물 함유 \xb7 갱년기건강 개선"
    ...
    (a) 산지\xb7품종 고유명사 1개 이상 ("경북 경산", "썬프레 천도", "청송", "멕시코 하스")
    (b) 정량 수치 1개 이상 (Brix, kg, 시간, 수확일, 재구매율 등)
    (c) 감각\xb7시간 트리거 1개 이상 ("아침 5시", "톡 터지는", "손끝에 배어나는", "이번 주 한정")
...
(a) 산지\xb7품종 고유명사 1개 이상
(b) 정량 수치 1개 이상 (Brix, kg, 시간, 수확일, 재구매율 등)
(c) 감각\xb7시간 트리거 1개 이상 (톡 터지는\xb7아침 5시\xb7이번 주 한정 등)

레퍼런스 톤 (실제 잘 팔리는 상세페이지 인용):
- "오늘도 신선한 아보카도 \xb7 From. 멕시코 / 프리미엄 아보카도"
- "새벽녘 농수산 \xb7 고당도 복숭아만의 특별함"
